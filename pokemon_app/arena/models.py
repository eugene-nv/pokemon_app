...
class Arena(models.Model):
    first_pokemon = models.ForeignKey(to=Pokemon, on_delete=models.CASCADE, related_name='Покемон', null=True,
                                      blank=True)
    second_pokemon = models.ForeignKey(to=Pokemon, on_delete=models.CASCADE, related_name='Противник', null=True,
                                      blank=True)
